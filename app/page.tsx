                    ...
                    <div className="w-full max-w-4xl bg-surface-light dark:bg-surface-dark/95 backdrop-blur-md rounded-2xl shadow-2xl p-4 md:p-6 transform translate-y-8 md:translate-y-12 border border-white/10">
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 pb-3 md:pb-0 md:pr-6">
                                ...
                                <select aria-label="Looking to buy or rent" className="w-full bg-transparent border-none text-text-main-light dark:text-white font-display font-semibold text-base sm:text-lg p-0 focus:ring-0 cursor-pointer outline-none">
                            ...
                            <div className="flex-1 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 pb-3 md:pb-0 md:pr-6">
                                ...
                                <input type="text" aria-label="Search by location" placeholder="City, Zip, or Address" className="w-full bg-transparent border-none text-text-main-light dark:text-white font-display font-semibold text-base sm:text-lg p-0 focus:ring-0 placeholder-gray-400 outline-none" />
                            </div>
                            <div className="flex-1 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 pb-3 md:pb-0 md:pr-6">
                                ...
                                <select aria-label="Property type" className="w-full bg-transparent border-none text-text-main-light dark:text-white font-display font-semibold text-base sm:text-lg p-0 focus:ring-0 cursor-pointer outline-none">
                            ...
                            <div className="md:w-auto flex items-end pt-2 md:pt-0">
                                <Link href="/properties" aria-label="Search Properties" className="w-full md:w-auto bg-primary hover:bg-primary-dark text-white px-8 h-full min-h-[50px] rounded-xl font-bold text-base sm:text-lg shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-2">
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] lg:aspect-auto lg:h-[700px]">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md border border-white/20 p-4 sm:p-6 rounded-xl flex justify-between text-center shadow-lg divide-x divide-white/20">
                                    <div className="px-2 w-1/3">
                                        <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-secondary font-display drop-shadow-sm">150+</p>
                                    ...
                                    <div className="px-2 w-1/3">
                                        <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-secondary font-display drop-shadow-sm">12</p>
